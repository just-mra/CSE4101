		...
		<div class="container " style=" ">
			<div class="row">
				<div class="col-md-12 d-flex">
					...
					<a href="display.php"><button class="btn" style=" background-color: yellow; margin-left:400px; width:520px; padding:10px; margin-top:10px; border-radius:10px;">Display Already Sign Up Data</button> </a>
				</div>
			</div>
		</div>
	</body>
